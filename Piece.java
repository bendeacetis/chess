    ...
    public boolean isMoveLegal(Board board, int endRow, int endCol) {
        switch (this.character) {
            ...
            case '\u265f':
                ...
                //Case 1: Pawn Promotion and Move
                if(pawn.isMoveLegal(board, endRow, endCol)){
                    //
                    if((endRow==0 && isBlack==false)||(endRow==7 && isBlack==true)){
                        Scanner scnr = new Scanner(System.in);
                        System.out.println("Promote this piece (q,k,b,r)");
                        String input = scnr.nextLine();
                        if(input.equals("q")){
                            if(isBlack){
                                //if black, change to a black queen character, and same for others below
                                this.character = '\u265B';
                            }
                            if(!isBlack){
                                this.character = '\u2655';
